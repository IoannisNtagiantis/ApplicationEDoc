In order to open our project to your machine you should click the green button name "Code" download the ZIP file. Then you should extract the file to the current diractory on which
